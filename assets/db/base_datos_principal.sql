...
INSERT INTO `calles` (`id`, `nombre`, `tipo`, `ano_inicio`, `ano_fin`, `id_mapa`) VALUES
(4, 'Calderon', 'Plaza', 0, 0, NULL);
...
INSERT INTO `mapas` (`id`, `titulo`, `descripcion`, `ciudad`, `fecha`, `imagen`, `nivel`, `ancho`, `altura`, `fecha_de_subida`, `id_paquete`, `desviacion_x`, `desviacion_y`, `principal`) VALUES
(36, 'Almeria', '', '', 2018, 'assets/img/mapas/36_almeria.png', 0, 4000, 2534, '2019-04-29 09:52:23', 0, NULL, NULL, 1);
...
--
-- Volcado de datos para la tabla `mapas_calles`
--

INSERT INTO `mapas_calles` (`id_map`, `id_lamina`, `id_calle`) VALUES
(25, NULL, 63),
(23, NULL, 63),
(13, NULL, 63),
(1, NULL, 64),
