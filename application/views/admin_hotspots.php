    ...
    <div class="modal fade bd-example-modal-xl" id="modal_leyenda" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul>
                        <li> Click y arrastrar para moverte por el mapa </li>
                        <li> Doble click izquierdo para crear un punto </li>
                        <li> Click derecho para borrar punto </li>
                        <li> Hacer zoom con la rueda del raton </li>
                    </ul>
                </div> <!-- fin modal body -->
                <div class='modal-footer'>
